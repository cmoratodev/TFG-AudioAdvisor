...
export const metadata: Metadata = {
  // `%s` placeholder is filled by per-page `title` exports. Pages that want
  // a literal full title override with `title: { absolute: '...' }`.
  title: {
  ...
  // Default OG / Twitter cards inherited by every page unless overridden.
...
export default function RootLayout({
  ...
  return (
    ...
    >
      {/* Body bg is the FALLBACK colour while the AmbientBackground layer
       *  paints over it. Keeping a solid colour here avoids a flash of pure
       *  white if the background component hasn't hydrated yet. */}
      <body className="flex min-h-full flex-col bg-[#fbfaff] text-zinc-950 selection:bg-zinc-200">
        <SessionProvider>
          {/* Skip-to-main: visible only on keyboard focus — see globals.css */}
